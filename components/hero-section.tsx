      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold text-balance mb-4">
            Hi, I'm <span className="text-primary">Ganesh Borole</span>
          </h1>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty mb-8">
            I create beautiful, functional web applications using React, Next.js, and modern technologies. Passionate
            about clean code, exceptional user experiences, and building solutions that make a difference.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button onClick={scrollToProjects} size="lg" className="font-semibold">
            View My Work
        ...
        <div className="flex justify-center space-x-6">
          <Button variant="ghost" size="sm" className="p-2" asChild>
            <a href="https://github.com/GaneshBorole" target="_blank" rel="noopener noreferrer">
              <Github className="h-5 w-5" />
              <span className="sr-only">GitHub</span>
            </a>
          </Button>
          <Button variant="ghost" size="sm" className="p-2" asChild>
            <a href="https://www.linkedin.com/in/ganesh-borole-85a7862b0/" target="_blank" rel="noopener noreferrer">
              <Linkedin className="h-5 w-5" />
              <span className="sr-only">LinkedIn</span>
            </a>
          </Button>
          <Button variant="ghost" size="sm" className="p-2" asChild>
            <a href="mailto:https://ganeshborole73@gmail.com">
